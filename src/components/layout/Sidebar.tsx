...
const NavItem: React.FC<{ href: string; icon: React.ElementType; label: string; isSubItem?: boolean }> = ({ href, icon: Icon, label, isSubItem = false }) => {
  return (
    <NavLink
      to={href}
      end
...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="hidden lg:flex lg:flex-col lg:w-64 bg-gray-800 text-white fixed h-full">
